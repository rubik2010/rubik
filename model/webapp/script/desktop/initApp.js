$(function () {
	 //远程数据加载路径
	$.fn.app.defaults.loadUrl = {
				app : root+'/script/desktop/apps.json', //app数据
				startMenu : root+'/script/desktop/startMenu.json', //开始菜单数据
				widget : root+'/script/desktop/widget.json'
	};
    $('body').app({
